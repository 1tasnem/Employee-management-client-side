  ...
  if (isLoading || isFetching) {
    return (
      <>
        ...
        <div className="max-w-4xl mx-auto p-6 bg-teal-200 rounded-lg shadow-lg">
          <div className="flex items-center space-x-4">
            <div className="w-32 h-32 rounded-full border-4 object-cover skeleton bg-gray-300 border-blue-500 shadow-md" />
            <div>
              <h1 className="text-4xl font-bold text-gray-800 skeleton bg-slate-200 h-8 w-52"></h1>
          ...
          <div className="mt-8 p-4 bg-indigo-50 border-l-4 ">
